                                ...
                                view! {
                                    <div class="box mb-4">
                                        ...
                                        <table class="table is-fullwidth is-hoverable">
                                            <thead>
                                                <tr>
                                                    <th style="width:11em; cursor:pointer; user-select:none;"
                                                        on:click=move |_| {
                                                    ...
                                                    <th style="width:3.5em; cursor:pointer; user-select:none;"
                                                        on:click=move |_| {
                                                    ...
                                                    <th style="width:6em; cursor:pointer; user-select:none;"
                                                        on:click=move |_| {
